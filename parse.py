...
class parser():
    ...
    parser.add_argument('actions', choices=['buy', 'sell', 'inventory', 'advance-time', 'set-date', 'backup', 'userguide', 'readme', 'profit'], help='Run "python main.py userguide" for more help')
    ...
    parser.add_argument('-dt', '--date', type=lambda d: datetime.strptime(d, '%d%m%Y'), help="Use ddmmyyyy!")
